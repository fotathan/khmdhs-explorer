...
-- categories 120-126 and 83 subcategories hand-translated from Greek (not in
-- the source file). DB coverage after apply: cpv 9454/9454, categories 66/66,
-- subcategories 321/321 — full. VALUES carry extra source-file ids not in the
-- DB; those are harmless no-op matches. Run on local AND Supabase.
...
ALTER TABLE proc.tender_subcategory ADD COLUMN IF NOT EXISTS name_en text;

UPDATE proc.tender_category AS c SET name_en = v.en
FROM (VALUES
  (1, 'Occupational health and safety, protective and work clothing, occupational health and safety products and products'),
  (2, 'Construction - facilities'),
  (4, 'Construction - renovations, finishing'),
  (5, 'Heating and gas'),
  (6, 'Roofing'),
  (7, 'Road construction'),
  (8, 'Education, training'),
  (9, 'Economics, law and organization'),
  (10, 'Energy-electric'),
  (11, 'Finance - banking'),
  (12, 'Finance - leasing'),
  (14, 'Finance - insurance'),
  (15, 'Gastronomy, catering'),
  (16, 'Geodesy, geology, archaeology, cartography, spatial development'),
  (17, 'Mining'),
  (18, 'Computers, IT, office technology'),
  (19, 'Facades, thermal modernization'),
  (20, 'Cosmetics, cleaning products'),
  (22, 'Forestry, agriculture, breeding'),
  (23, 'Construction and metallurgical materials'),
  (25, 'Mechanics and metallurgy'),
  (26, 'Medical'),
  (27, '[Automotive] Vehicles, Transport Equipment, Parts and Services'),
  (28, 'Real estate, land, parking lots, administration'),
  (29, 'Security'),
  (30, 'Clothing, footwear, textiles'),
  (31, 'Packaging'),
  (32, 'Printing, Publishing'),
  (33, 'Passenger transport'),
  (34, 'Locksmithing and joinery, glass-making'),
  (35, 'Food'),
  (36, 'Cleaning'),
  (37, 'Machines, equipment, devices, tools'),
  (39, 'Raw materials, fuels, oils'),
  (40, 'Electronics, RTV, household appliances, multimedia'),
  (42, 'Industrial automation'),
  (43, 'Tourism, leisure, hotel industry, sports'),
  (44, 'Information services, databases, translations'),
  (45, 'Transportation services'),
  (46, 'Ventilation and air conditioning'),
  (47, 'Elevators and cranes'),
  (48, 'Water and sewage'),
  (50, 'Interior furnishings'),
  (101, 'Projects'),
  (103, 'Green areas'),
  (104, 'Social assistance, care services'),
  (105, 'Work'),
  (106, 'Merchandise vouchers'),
  (107, 'Structures, fences'),
  (108, 'Laboratories'),
  (109, 'Services for the population'),
  (110, 'Ecology, environment'),
  (111, 'Chemical materials'),
  (113, 'Stationery and school supplies'),
  (115, 'Telecommunications, Telephones'),
  (116, 'Culture, art'),
  ...
  (703, 'Research and development services'),
  (704, 'Utilities and network operation services'),
  (705, 'Community, personal and association services')
) AS v(id, en) WHERE c.id = v.id;

UPDATE proc.tender_subcategory AS s SET name_en = v.en
FROM (VALUES
  (122, 'Services, training'),
  (123, 'Protective and work clothing'),
  (124, 'Articles, accessories'),
  (125, 'Sports facilities'),
  (126, 'Historic objects'),
  (127, 'Commercial facilities'),
  (128, 'Other objects'),
  (129, 'Public utility facilities'),
  (130, 'Housing'),
  (131, 'Small-sized objects'),
  (132, 'Warehouses, production plants'),
  (133, 'Other construction works'),
  (134, 'Painting, renovation, finishing'),
  (135, 'Reconstruction, adaptation, modernization of rooms'),
  (136, 'Armature'),
  (137, 'Heating installations'),
  (138, 'Gas installations'),
  (139, 'Industrial installations'),
  (140, 'Boiler rooms'),
  (141, 'Chimneys'),
  (142, 'Combined heat and power plants'),
  (143, 'Gas networks'),
  (144, 'Heating block'),
  (145, 'Stove fitting services'),
  (146, 'Incinerator'),
  (147, 'Roofing materials'),
  (148, 'Roofing works'),
  (149, 'Sheet metal working'),
  (150, 'Roads, streets, highways, bypasses'),
  (151, 'Bridges, viaducts'),
  (152, 'Pitches'),
  (153, 'Railway and tram lines'),
  (154, 'Road traffic organization'),
  (155, 'Road maintenance'),
  (156, 'Retaining wall'),
  (157, 'Earthworks, equipment rental'),
  (158, 'Land use'),
  (159, 'Education'),
  (160, 'Other courses and training'),
  (161, 'Financial Statements'),
  (162, 'Accounting services'),
  (163, 'Analysis of enterprise development'),
  (164, 'Legal services'),
  (165, 'Analyses, audits, certificates'),
  (166, 'Energy-electric internal installations'),
  (167, 'Energy-electric external networks'),
  (168, 'Lighting'),
  (169, 'Devices, materials'),
  (171, 'Credits, loans'),
  (172, 'Banking services'),
  (173, 'Property and communication'),
  (174, 'Group and life'),
  (175, 'Brokerage services, consulting'),
  (176, 'Pension funds'),
  (177, 'Restaurant services'),
  (178, 'Catering services'),
  (179, 'Collective feeding'),
  (180, 'Cartography'),
  (181, 'Geological services'),
  (182, 'Surveying services, inventories'),
  (183, 'Spatial development'),
  (184, 'Land and building records'),
  (185, 'Mining services'),
  (186, 'Equipment, mining machines'),
  (187, 'Computers, servers'),
  (188, 'Computer parts'),
  (189, 'IT services'),
  (190, 'Devices, office and computer accessories'),
  (191, 'Toners, cartridges, inks'),
  (192, 'Computer software'),
  (193, 'Computer & IT service, repair'),
  (194, 'Shredders, guillotines, binding machines, packaging machines'),
  (195, 'Computer network installation'),
  (196, 'Cleaning products'),
  (198, 'Cosmetics and hygiene products'),
  (199, 'Cleaning equipment'),
  (200, 'Plant protection products, fertilizers'),
  (203, 'Plants, grains, feed'),
  (204, 'Hunting and fishing services'),
  (205, 'Breeding, catching homeless animals'),
  (206, 'Services related to forestry and agriculture'),
  (207, 'Bearings'),
  (208, 'Mechanics and metallurgy - Metallurgical products'),
  (209, 'Metallurgical castings'),
  (210, 'Mechanical processing'),
  (211, 'Locksmith service'),
  (212, 'Medicines'),
  (216, 'Conditioners'),
  (217, 'Medical transport'),
  (218, 'Medical equipment'),
  (220, 'Medical furniture'),
  (221, 'Medical gas'),
  (222, 'Medical services'),
  (223, 'Cars'),
  (224, 'Lorries'),
  (225, 'Specialized cars'),
  (226, 'Accessories, fluids'),
  (227, 'Plates'),
  (228, 'Auto parts'),
  (229, 'Real estate administration'),
  (230, 'Real estate technical service'),
  (231, 'Land'),
  (232, 'Parking lots'),
  (233, 'Security equipment installations'),
  (234, 'Fire protection equipment and installations'),
  (235, 'Debt collection'),
  (236, 'Protection of people and property'),
  (237, 'Anti-burglary equipment'),
  (238, 'Clothes'),
  (239, 'Footwear'),
  (240, 'Textiles'),
  (241, 'Various packaging'),
  (242, 'Foil products'),
  (243, 'Construction project'),
  (244, 'Road project'),
  (245, 'Roofing project'),
  (246, 'Telecommunications project'),
  (247, 'Structure design'),
  (248, 'Green area design'),
  (249, 'Water and sewage project'),
  (250, 'Thermal modernization project'),
  (251, 'Power electric project'),
  (252, 'Elevator design and cranes'),
  (253, 'Heating and gas project'),
  (254, 'Ventilation design'),
  (255, 'Project different'),
  (256, 'Supervision, cost estimate, review'),
  (257, 'Railway and tram line design'),
  (258, 'Project in the computer industry'),
  (259, 'Project in the security industry'),
  (260, 'Groceries'),
  (261, 'Stimulants'),
  (262, 'Disinfection, disinfestation, rodent control'),
  (263, 'Laundry services'),
  (264, 'Cleaning rooms'),
  (265, 'Cleaning the area'),
  (266, 'Demolition, dismantling'),
  (267, 'Garbage collection, disposal, landfills'),
  (268, 'Containers and garbage containers'),
  (269, 'Fuel resources'),
  (270, 'Natural resources'),
  (271, 'Recyclable materials'),
  (272, 'Greases, oils'),
  (273, 'Windows, doors'),
  (274, 'Skylights, shop windows'),
  (275, 'Telecommunications services'),
  (276, 'Radiotelephone equipment'),
  (277, 'Networks, telecommunications and telephone installations'),
  (278, 'Maintenance services, inspections, towing'),
  (279, 'Green'),
  (280, 'Playgrounds'),
  (281, 'Small architecture'),
  (282, 'Tickets'),
  (283, 'Hotel industry'),
  (284, 'Organization of sports events'),
  (286, 'Trips and recreation'),
  (288, 'Information services'),
  (289, 'Database'),
  (290, 'Translations'),
  (291, 'Transport'),
  (292, 'Courier and postal services'),
  (293, 'Ventilation and air conditioning installations'),
  (294, 'Devices'),
  (295, 'Freight and passenger elevators, platforms'),
  (296, 'Cranes, overhead cranes, cranes'),
  (297, 'Water and sewage external networks'),
  (298, 'Water and sewage internal installations'),
  (299, 'Water purification'),
  (300, 'Water areas and hydrotechnics'),
  (302, 'Materials and devices'),
  (303, 'Furniture and accessories'),
  (304, 'Ceramics and decorations'),
  (305, 'Interior design'),
  (306, 'Blinds roller blinds'),
  (307, 'Sauna'),
  (308, 'Expert opinions, forecasts'),
  (309, 'Environmental Protection'),
  (310, 'Household appliances'),
  (311, 'TV equipment, multimedia'),
  (312, 'TV'),
  (313, 'Facades'),
  (314, 'Thermal modernization'),
  (315, 'Large-scale structures'),
  (316, 'Fences'),
  (317, 'Other structures'),
  (318, 'Maintenance and anti-corrosion works'),
  (319, 'Gates'),
  (320, 'Cultural activities'),
  (321, 'Works of art, commemorative plaques'),
  (322, 'Laboratory equipment'),
  (323, 'Laboratory supplies'),
  (324, 'Laboratory services'),
  (325, 'Aircraft'),
  (326, 'Floating equipment'),
  (327, 'Construction machinery'),
  (328, 'Industrial machines'),
  (329, 'Other machines and equipment'),
  (331, 'Sport equipment'),
  (332, 'Musical instruments'),
  (333, 'Small devices'),
  (334, 'Building Materials'),
  (335, 'Construction and metallurgical materials - Metallurgical products'),
  (336, 'Chemicals'),
  (337, 'Water cleaning reagents'),
  (338, 'Office and stationery supplies'),
  (339, 'Learning materials'),
  (340, 'Magazines, books, calendars'),
  (341, 'Forms, folders, guides'),
  (342, 'Photocopying, printing and other services'),
  (343, 'Social assistance'),
  (344, 'Care services'),
  (345, 'Funeral services'),
  (346, 'Logos and graphic signs'),
  (347, 'Gadgets'),
  (348, 'Advertising and notice boards'),
  (349, 'Promotional campaigns'),
  (350, 'Ads'),
  (351, 'Document Archiving'),
  (352, 'Estimates'),
  (353, 'Medical materials'),
  (355, 'Sale of electricity'),
  (356, 'Service of sports facilities'),
  (357, 'Road equipment'),
  (358, 'Energy expertise'),
  (359, 'Archaeological services'),
  (361, 'Medical and disposable clothing'),
  (362, 'Locksmith services'),
  (363, 'Water facilities'),
  (364, 'Gas stations'),
  (365, 'Airports, landing strips'),
  (366, 'Military facilities'),
  (367, 'Heat sales'),
  (368, 'Gas sales'),
  (369, 'Soft-Skills training'),
  (370, 'Driving courses'),
  (371, 'Language courses'),
  (372, 'Vocational training'),
  (373, 'IT courses'),
  (374, 'Property valuation'),
  (375, 'Consulting, advice'),
  (376, 'EU funds'),
  (377, 'Household accessories'),
  (379, 'Biogas, biomass'),
  (380, 'Renewable energy different'),
  (381, 'Solar energy'),
  (382, 'Wind energy'),
  (383, 'Hydropower'),
  (384, 'Geothermal'),
  (385, 'Cogeneration, trigeneration'),
  (386, 'Heat pumps'),
  (387, 'Agricultural machinery and equipment'),
  (388, 'Military equipment'),
  (389, 'Construction accessories'),
  (390, 'Welding supplies'),
  (391, 'Veterinary medicine'),
  (392, 'Veterinary - equipment'),
  (393, 'Veterinary - materials'),
  (394, 'Veterinary - services'),
  (395, 'Medical - service, repair'),
  (396, 'Tires'),
  (397, 'Two-wheeled vehicles, quads'),
  (398, 'Vans'),
  (399, 'Buses, coaches'),
  (400, 'Protection accessories'),
  (401, 'Renewable energy project'),
  (402, 'Vending machines'),
  (403, 'Fuel raw materials'),
  (404, 'Aggregates'),
  (405, 'Technical gases'),
  (406, 'Road salt'),
  (407, 'Mass events'),
  (408, 'Technical support for events'),
  (409, 'Conferences'),
  (410, 'Warehouse services, logistics'),
  (411, 'Air transport'),
  (412, 'Sea/maritime transport'),
  (413, 'Rail transport'),
  (414, 'Pipeline transport'),
  (415, 'Travel agency services'),
  (416, 'Recreation and leisure activities'),
  (417, 'Cinema, video and broadcasting services'),
  (418, 'Libraries, museums, archives'),
  (419, 'News, press and information agencies'),
  (420, 'Business and management consultancy services'),
  (421, 'Recruitment and staffing services'),
  (422, 'General business support services'),
  (423, 'Hairdressing and personal-care services'),
  (424, 'Membership organisations and associations'),
  (425, 'Religious goods and services'),
  (426, 'Domestic and household services'),
  (427, 'Health services'),
  (428, 'Forestry and timber products'),
  (429, 'Aquaculture and fishing services'),
  (430, 'Electric motors, generators, transformers'),
  (431, 'Batteries and accumulators'),
  (432, 'Water supply services'),
  (433, 'Sewage cleaning and treatment services'),
  (434, 'Environmental services and waste management'),
  (435, 'Hazardous and radioactive waste management'),
  (436, 'Architectural services'),
  (437, 'Engineering services'),
  (438, 'Urban planning and landscape design'),
  (439, 'Other technical testing and analysis'),
  (440, 'Computer-related services'),
  (441, 'Office machinery and equipment (except computers)'),
  (442, 'Industrial machinery and parts'),
  (443, 'Machine tools'),
  (444, 'Refrigeration, ventilation and cooling equipment'),
  (445, 'Pumps and compressors'),
  (446, 'Furnaces and ovens (industrial)'),
  (447, 'Machinery for textile, food and paper industries'),
  (448, 'Measuring, control and testing instruments'),
  (449, 'Optical instruments'),
  (450, 'Navigation, meteorology and geophysics instruments'),
  (451, 'Clocks, watches and timekeeping'),
  (452, 'Jewellery, watches and gift items'),
  (453, 'Furs, leather goods and luggage'),
  (454, 'Toys, games and handicraft items'),
  (455, 'Photographic equipment and services'),
  (456, 'Vehicle bodies, spare parts and accessories'),
  (457, 'Ships, boats and marine equipment'),
  (459, 'Funeral and mortuary supplies'),
  (460, 'Pipe valves, fittings and conduits'),
  (461, 'Tanks, containers and pressure vessels'),
  (462, 'Tools, locks, keys and fasteners'),
  (463, 'Paints, varnishes and coatings'),
  (464, 'Dyes, pigments and fine chemicals'),
  (465, 'Explosives and pyrotechnics'),
  (466, 'Adhesives and essential oils'),
  (467, 'Printing inks and printing consumables'),
  (468, 'Various non-metallic mineral products'),
  (469, 'Ores, base metals and alloys'),
  (470, 'Public order, defence and fire-rescue services'),
  (471, 'Social security services'),
  (472, 'General administrative services'),
  (473, 'Research and development services — general'),
  (474, 'Research and development — defence and security'),
  (475, 'Drilling and well services'),
  (476, 'Specialised oil and gas services'),
  (477, 'Plastics and rubber products'),
  (478, 'Synthetic fibres and synthetic rubber'),
  (479, 'Plastic and rubber waste'),
  (480, 'Secondary raw materials'),
  (481, 'Weapons, ammunition and military equipment'),
  (482, 'Space transport and satellite services'),
  (483, 'Plant raw materials and forest products'),
  (484, 'Livestock and animal husbandry'),
  (485, 'Cork, pulp and cellulose'),
  (486, 'Nuclear fuels and energy'),
  (487, 'General textile products'),
  (488, 'Installation services — general'),
  (489, 'Retail and hospitality services'),
  (490, 'Auxiliary transport services'),
  (491, 'Real-estate development and brokerage'),
  (492, 'Glass and optical fibres'),
  (493, 'Passenger transport modes'),
  (494, 'Investment and financial services'),
  (500, 'Agricultural and horticultural products'),
  (501, 'Livestock and animal accessories'),
  (502, 'Forestry and timber products'),
  (503, 'Natural rubber, cork and cellulose'),
  (504, 'Fuels and energy commodities'),
  (505, 'Mineral products and aggregates'),
  (506, 'Metal ores, base metals and recovered materials'),
  (507, 'Jewelry, watches and gift items'),
  (508, 'Luggage, bags and saddlery'),
  (509, 'Leather, rubber and plastics'),
  (510, 'Printed materials and printing supplies'),
  (511, 'Office supplies and printed stationery'),
  (512, 'Chemical raw materials and polymers'),
  (513, 'Explosives and pyrotechnic chemicals'),
  (514, 'Office machines and equipment'),
  (515, 'Electrical equipment and components'),
  (516, 'Batteries and accumulators'),
  (517, 'Telecommunications equipment and networks'),
  (518, 'Funeral and post-mortem supplies'),
  (519, 'Transport vehicles and equipment'),
  (520, 'Ships, boats and marine equipment'),
  (521, 'Security, police and defence equipment'),
  (522, 'Sports, leisure, games and hobby equipment'),
  (523, 'Measuring, testing and scientific instruments'),
  (524, 'Furniture, fittings and general equipment'),
  (525, 'Water supply products'),
  (526, 'Industrial machinery and machine tools'),
  (527, 'Cooling, ventilation and heat-exchange equipment'),
  (528, 'Mining and construction machinery'),
  (529, 'Construction materials and accessories'),
  (530, 'Building installation and finishing work'),
  (531, 'Construction machinery rental with operators'),
  (532, 'Software and information systems'),
  (533, 'Vehicle repair and maintenance'),
  (534, 'Transport equipment repair and maintenance'),
  (535, 'Industrial equipment repair and maintenance'),
  (536, 'Building equipment repair and maintenance'),
  (537, 'Various repair and maintenance services'),
  (538, 'Installation of equipment and machinery'),
  (539, 'Installation of specialized equipment'),
  (540, 'Hotel, accommodation and retail services'),
  (541, 'Transport and logistics services'),
  (542, 'Passenger transport services'),
  (543, 'Freight handling and warehousing'),
  (544, 'Travel agency and tourist support services'),
  (545, 'Banking, investment and financial markets'),
  (546, 'Insurance and reinsurance'),
  (547, 'Financial management and liquidity services'),
  (548, 'Real estate development, rental and transactions'),
  (549, 'Architecture, engineering and construction supervision'),
  (550, 'Technical testing, analysis and control'),
  (551, 'Data, internet and information services'),
  (552, 'Research and development services'),
  (553, 'Research consulting and planning'),
  (554, 'Public administration services'),
  (555, 'Defence, justice and public safety services'),
  (556, 'Social security and public benefit services'),
  (557, 'Utility operation and supply services'),
  (558, 'Oil and gas extraction and drilling services'),
  (559, 'Horticulture, aquaculture, zoology and beekeeping'),
  (560, 'Business services and office support'),
  (561, 'Employment and staffing services'),
  (562, 'Education and training services'),
  (563, 'Health and social services'),
  (564, 'Wastewater and sewer services'),
  (565, 'Environmental protection services'),
  (566, 'Cleaning and hygiene services'),
  (567, 'Recreation, culture and media services'),
  (568, 'Libraries, archives, museums and heritage institutions'),
  (569, 'Sports and leisure services'),
  (570, 'Association and organization services'),
  (571, 'Personal care and wellbeing services'),
  (572, 'Domestic, international and extraterritorial services'),
  (573, 'Heating, boilers and radiators'),
  (574, 'Lifting and conveying equipment'),
  (575, 'Specialized production machinery'),
  (576, 'General purpose machinery and parts'),
  (577, 'Laboratory furniture and equipment'),
  (578, 'Musical instruments and arts/crafts supplies'),
  (579, 'Magnetic cards and labels'),
  (580, 'Market research, surveys and statistics'),
  (581, 'Crisis management services'),
  (582, 'Food, beverages and tobacco'),
  (583, 'Rubber and plastic waste'),
  (584, 'Fire protection equipment'),
  (585, 'Locks, keys and metal fittings'),
  (586, 'Tanks, containers and packaging'),
  (587, 'Paints, coatings and solvents'),
  (588, 'Construction works - general'),
  (589, 'Site preparation and civil engineering works'),
  (590, 'Mechanical and technical building installations'),
  (591, 'Electrical installation works'),
  (592, 'Telecommunications installation works'),
  (593, 'Laboratory equipment installation'),
  (594, 'Metal tanks and container installation'),
  (595, 'Industrial automation and control systems'),
  (596, 'Parking and metering equipment'),
  (597, 'Broadcasting and media services'),
  (598, 'Libraries, archives, museums and gardens'),
  (599, 'Septic and sewer cleaning services'),
  (600, 'Animal boarding and kennel services'),
  (601, 'Equal opportunities and population services'),
  (602, 'Workwear'),
  (603, 'Safety footwear and protective clothing'),
  (607, 'Building construction and civil engineering works'),
  (608, 'Business, legal, marketing and consulting services'),
  (609, 'Electrical machinery, apparatus and supplies'),
  (610, 'Electrical cables and conductors'),
  (611, 'Banking, investment and financial services'),
  (612, 'Photocopiers and offset printing equipment'),
  (613, 'Computer systems and accessories'),
  (614, 'Software packages and information systems'),
  (615, 'IT consulting, development, internet and support services'),
  (616, 'Grains, vegetables, fruit and nuts'),
  (617, 'Animal and aquaculture products'),
  (618, 'Agriculture, forestry, aquaculture and beekeeping services'),
  (619, 'Gravel, sand, crushed stone and aggregates'),
  (620, 'Building materials and construction products'),
  (621, 'Alloys'),
  (622, 'Medical equipment, pharmaceuticals and personal care products'),
  (623, 'Healthcare and medical services'),
  (624, 'Vehicles, transport equipment and parts'),
  (625, 'Ships'),
  (626, 'Aircraft and spacecraft'),
  (627, 'Real estate and property management services'),
  (628, 'Security, emergency, police and military equipment'),
  (629, 'Outerwear'),
  (630, 'Special clothing and accessories'),
  (631, 'Leather'),
  (632, 'Fabrics and related articles'),
  (633, 'Textile yarns and threads'),
  (634, 'Books, publications and printed matter'),
  (635, 'Printed stationery, forms and paper products'),
  (636, 'Printing, publishing and event support services'),
  (637, 'Meat and meat products'),
  (638, 'Fish, seafood and preserved fish'),
  (639, 'Fruit, vegetables and related products'),
  (640, 'Oils and fats'),
  (641, 'Dairy products'),
  (642, 'Milling products and starches'),
  (643, 'Animal feed'),
  (644, 'Prepared and miscellaneous foods'),
  (645, 'Agricultural and forestry machinery and parts'),
  (646, 'Kitchen equipment, household and home goods, catering supplies'),
  (647, 'Catering facilities'),
  (648, 'Home textiles'),
  (649, 'Industrial machinery and special-purpose equipment'),
  (650, 'Construction, mining and earthmoving machinery'),
  (651, 'Solid, gaseous and mineral fuels'),
  (652, 'Petroleum, coal and oil products'),
  (653, 'Fertilizer minerals'),
  (654, 'Rock salt'),
  (655, 'Rubber goods'),
  (656, 'Industrial and technical gases'),
  (657, 'Sports, games, toys and recreational equipment'),
  (658, 'Hotel, restaurant, catering and accommodation services'),
  (659, 'Entertainment, recreation and sports services'),
  (660, 'Lifting, handling and crane equipment'),
  (661, 'Pipes, water, sewerage and drainage materials'),
  (662, 'Wastewater, sewage and water-related services'),
  (663, 'Architecture, engineering and project services'),
  (664, 'Green areas, landscaping and horticultural services'),
  (665, 'Social work and social care services'),
  (666, 'Technical testing and laboratory services'),
  (667, 'Public institution and population services'),
  (668, 'Environmental, waste and remediation services'),
  (669, 'Chemicals and chemical preparations'),
  (670, 'Radio, television, audio and transmission equipment'),
  (671, 'Networks, telecommunications and data equipment'),
  (672, 'Telecommunications and data transmission services'),
  (673, 'Musical instruments, arts and handicrafts'),
  (674, 'Film, video, cultural and museum services'),
  (675, 'Measuring, navigation, optical and precision instruments'),
  (676, 'Public administration, defence and statutory services'),
  (677, 'Installation services'),
  (678, 'Research, development, testing and evaluation services'),
  (679, 'Gas, electricity and utility supply services'),
  (680, 'Personal, domestic, community and funeral services'),
  (681, 'Installation of lighting and signaling systems'),
  (682, 'Electricity, steam and energy commodities')
) AS v(id, en) WHERE s.id = v.id;

UPDATE proc.cpv_code AS c SET description_en = v.en
FROM (VALUES
...
) AS v(code, en) WHERE c.cpv_code = v.code;
