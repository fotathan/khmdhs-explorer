...
Usage:
  ...
  Tender Service   : tsg-backfill | tsg-catchup | tsg-project | tsg-match
                     (not in production: refused on prod unless TSG_INGEST_REMOTE=1)
...
case "$COMMAND" in
  backfill|catchup|fulltext-backfill|diavgeia-backfill|diavgeia-catchup|diavgeia-resolve|diavgeia-project|ted-backfill|ted-catchup|ted-project|ted-fulltext-backfill|ted-lot-backfill|tsg-backfill|tsg-catchup|tsg-project|tsg-match) ;;
  *) die "second argument must be one of: backfill, catchup, fulltext-backfill, diavgeia-backfill, diavgeia-catchup, diavgeia-resolve, diavgeia-project, ted-backfill, ted-catchup, ted-project, ted-fulltext-backfill, ted-lot-backfill, tsg-backfill, tsg-catchup, tsg-project, tsg-match (got '$COMMAND')";;
esac
