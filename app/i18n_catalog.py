...
_HELP = {
    ...
    "Ο διακόπτης ΕΛ / EN (πάνω δεξιά) εναλλάσσει όλο το περιβάλλον μεταξύ ελληνικών και αγγλικών και θυμάται την επιλογή σας. Οι ετικέτες δεδομένων — τύποι πράξεων, είδη διαδικασίας, ονόματα CPV και NUTS — μεταφράζονται μαζί.": "The ΕΛ / EN switch (top-right) flips the whole interface between Greek and English and remembers your choice. Data labels — act types, procedure kinds, CPV and NUTS names — are translated too.",
    ...
    "Φίλτρο": "Filter",
    "Λειτουργία": "Function",
    "Περιορισμός σε ΚΗΜΔΗΣ, Διαύγεια ή TED.": "Restrict to ΚΗΜΔΗΣ, Διαύγεια or TED.",
    ...
    "όπου ΑΔΑΜ είναι ο μοναδικός αριθμός αναφοράς της πράξης. Είναι η πιο πλούσια προβολή της εφαρμογής.": "where ΑΔΑΜ is the act's unique reference number. It's the richest view in the app.",
    "Κεφαλίδα": "Header",
    ...
    "ΑΔΑΜ, είδος διαδικασίας & κριτηρίου, σημαίες συμφωνίας-πλαισίου, ημ/νία υπογραφής.": "ΑΔΑΜ, procedure & criterion type, framework-agreement flags, signing date.",
    "Είδη / αντικείμενο": "Items / object",
    ...
    "Ο ΑΔΑΜ είναι το καθολικό κλειδί: έτσι βρίσκουν η προκήρυξη, το αποτέλεσμα, η σύμβαση και η πληρωμή του ίδιου διαγωνισμού η μία την άλλη, και πάνω του χτίζεται κάθε διεύθυνση": "The ΑΔΑΜ is the universal key: it's how the notice, result, contract and payment for the same tender find each other, and every",
    ...
    "με τη δραστηριότητα και τα σύνολά του. Οι αρχές εμπλουτίζονται από τον κατάλογο φορέων της Διαύγειας.": "with its activity and totals. Authorities are enriched from the Διαύγεια organisation directory.",
    "Δείτε προμηθευτές στο": "See suppliers at",
    "με κλειδί το ΑΦΜ· κάθε προφίλ στο": "keyed by ΑΦΜ; each profile at",
    "δείχνει τις συμβάσεις που κέρδισαν. Οι εγγραφές μπορούν να εμπλουτιστούν κατ' απαίτηση από το μητρώο ΓΕΜΗ μέσω ΑΦΜ.": "shows the contracts they won. Records can be enriched on demand from the ΓΕΜΗ registry by ΑΦΜ.",
    ...
    "Αποφάσεις διαφάνειας (με κλειδί ΑΔΑ), συν τον κατάλογο φορέων για τον εμπλουτισμό των αρχών.": "Transparency decisions (ΑΔΑ-keyed), plus the organisation directory used to enrich authorities.",
    ...
    "υπάρχει εξαγωγέας εγγράφου-σε-φύλλο: βγάλτε τους πίνακες από τα συνημμένα ενός διαγωνισμού και πάρτε καθαρό Excel. Τροφοδοτήστε το είτε με ΑΔΑΜ (κατεβάζει τα έγγραφα) είτε ανεβάζοντας αρχεία.": "there's a document-to-spreadsheet extractor: pull the tables out of a tender's attachments and get clean Excel. Feed it either by ΑΔΑΜ (it downloads the documents) or by uploading files.",
    ...
    "Το Γενικό Εμπορικό Μητρώο, για εμπλουτισμό αναδόχων και αρχών μέσω ΑΦΜ.": "The General Commercial Registry, for enriching contractors and authorities by ΑΦΜ.",
